...
// Aplicando el método map sobre dos claves
...
console.log(JSON.stringify({ x: 9, y: 35, z:28 }));
...
// utilizando el método de filtro para extraer datos de una matriz
...
// Aplicando métodos map y filter
var filteredList = watchList
  ...
  .filter(movie => {
    // volver verdadero mantendrá el artículo
    // devuelve falso rechazará el artículo
